    ...
    <>
      ...
      <div style={{ position: "fixed", top: 0, right: 0 }}>
        ...
        <div>
          ...
          />
          {new Date(minFrame).toISOString().split('T')[0]}
          {' '}end
          <input
            type="number"
            value={maxFrame}
        ...
        <div>
          ...
          <input
            ...
            />
          {new Date(minHighlightedFrame).toISOString().split('T')[0]}
          {' '}end
          <input
            type="number"
        ...
        <div><button onClick={getFirstVesselData}>GET FIRST VESSEL DATA</button></div>
      </div>
      <FpsView />
    </>
  );
